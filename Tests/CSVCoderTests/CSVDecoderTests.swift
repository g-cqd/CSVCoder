...
struct CSVDecoderTests {
    ...
    // MARK: - Nested Codable Decoding Tests
    ...
    func nestedDecodingJSON() throws {
        ...
        // The actual JSON string should be: {"street":"789 Pine Rd","city":"Capital City","zipCode":"11111"}
        // In CSV, quotes inside quoted fields are escaped as ""
